        ...
        <div ref={domRef} className={`relative flex flex-col md:flex-row items-center justify-between gap-12 md:gap-24 transition-all duration-1000 ease-out transform ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            ...
            <div className={`md:w-1/2 flex flex-col justify-center ${side === 'left' ? 'md:items-end md:text-right order-2 md:order-1' : 'md:items-start md:text-left order-2 md:order-2'}`}>
                <div>
                    ...
                    <p className="text-slate-500 text-lg leading-relaxed max-w-sm">{description}</p>
                </div>
            </div>
...
export default function Home() {
  ...
  return (
    <main className="flex min-h-screen flex-col bg-white overflow-x-hidden font-sans text-slate-900 selection:bg-indigo-100 selection:text-indigo-900">
      ...
      {/* NAVIGATION */}
      <nav className={`fixed w-full z-50 top-0 left-0 transition-all duration-300 ${scrolled ? 'bg-white/90 backdrop-blur-md border-b border-slate-200 shadow-sm py-4' : 'bg-transparent py-6'}`}>
      ...
      <section className="relative pt-44 pb-24 text-center overflow-hidden">
        ...
        <div className="px-6 max-w-7xl mx-auto relative z-10">
          <div className="inline-flex items-center gap-2 px-4 py-1.5 bg-white border border-slate-200 rounded-full text-xs font-semibold text-slate-600 mb-8 shadow-sm hover:shadow-md hover:border-slate-300 transition-all cursor-default">
          ...
          <p className="text-xl text-slate-500 max-w-2xl mx-auto font-normal mb-12 leading-relaxed">
            Przełam barierę językową. Jeden agent obsługuje 20 rynków.<br className="hidden md:block"/>
            <span className="text-slate-900 font-medium">Zero tłumaczy. Zero opóźnień. 100% AI.</span>
          </p>

          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-20">
            <button className="w-full sm:w-auto px-8 py-4 bg-slate-900 text-white rounded-2xl text-base font-semibold hover:bg-slate-800 transition-all hover:scale-[1.02] shadow-xl shadow-slate-900/10 ring-4 ring-slate-100 active:scale-95">
              Dołącz do bety
            </button>
            <button className="w-full sm:w-auto px-8 py-4 bg-white text-slate-700 rounded-2xl text-base font-semibold border border-slate-200 hover:border-slate-300 hover:bg-slate-50 transition-all shadow-sm hover:shadow-md flex items-center justify-center gap-3 group active:scale-95">
          ...
          <p className="text-xs font-bold text-slate-400 uppercase tracking-widest mb-8">Technologia, której ufasz</p>
      ...
      <div className="w-full max-w-7xl mx-auto px-4 md:px-6 -mt-10 mb-32 relative z-20">
              ...
              <div className="flex-1 overflow-y-auto p-6 space-y-6">
                ...
                {activeChat.messages.length > 0 && activeChat.messages[activeChat.messages.length-1].sender === 'user' && (
                    <div className="flex justify-center mt-4">
                        <button className="bg-indigo-50 hover:bg-indigo-100 text-indigo-600 text-xs px-3 py-1.5 rounded-full flex items-center gap-2 transition-colors border border-indigo-200 shadow-sm">
      ...
      <section id="how-it-works" className="py-24 px-6 max-w-7xl mx-auto">
        <div className="text-center mb-24">
            ...
            <p className="text-lg text-slate-500 max-w-2xl mx-auto">Ścieżka, która poprowadzi Cię do międzynarodowego sukcesu. Prosta, logiczna, zautomatyzowana.</p>
        </div>
        ...
        <div className="relative space-y-24 md:space-y-0">
            ...
            <GrowthStep 
                ...
                side="right"
            >
                <div className="bg-white p-6 rounded-3xl border border-slate-100 shadow-xl shadow-slate-200/50 max-w-sm ml-auto transform hover:-translate-y-1 transition-transform duration-300">
            ...
            <GrowthStep 
                ...
                side="left"
            >
                <div className="bg-white p-6 rounded-3xl border border-slate-100 shadow-xl shadow-slate-200/50 max-w-sm mr-auto transform hover:-translate-y-1 transition-transform duration-300">
            ...
            <GrowthStep 
                ...
                side="right"
            >
                <div className="bg-white p-5 rounded-3xl border border-slate-200 shadow-xl shadow-slate-200/50 max-w-sm ml-auto transform hover:-translate-y-1 transition-transform duration-300">
            ...
            >
                <div className="bg-white p-6 rounded-3xl border border-emerald-100 shadow-xl shadow-emerald-500/10 max-w-sm mr-auto relative overflow-hidden transform hover:-translate-y-1 transition-transform duration-300">
                    ...
                    <div className="relative z-10">
                        <div className="text-5xl font-extrabold text-emerald-500 mb-2 tracking-tight">+40%</div>
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-6 text-center">
            <h3 className="text-2xl font-bold text-slate-900 mb-4">Działa z Twoim ekosystemem</h3>
            <p className="text-slate-500 mb-12">Bezproblemowa integracja z najpopularniejszymi platformami e-commerce i komunikatorami.</p>
            ...
            <div className="flex flex-wrap justify-center items-center gap-12 md:gap-20 opacity-70 grayscale hover:grayscale-0 transition-all duration-700">
                ...
                <div className="flex items-center gap-3 text-xl font-bold text-slate-700 hover:text-[#96BF48] transition-colors cursor-default group">
                    <svg className="w-8 h-8 group-hover:scale-110 transition-transform" viewBox="0 0 24 24" fill="currentColor"><path d="M22.95 9.6l-1.95-6.9L17.5 7.2 12.55 0 7.6 7.2 4.1 2.7 2.15 9.6c-.05.2-.05.45.05.65l8.55 11.2c.4.55 1.25.55 1.65 0l8.55-11.2c.1-.2.1-.45.05-.65z"/></svg>
                    Shopify
                </div>
                <div className="flex items-center gap-3 text-xl font-bold text-slate-700 hover:text-[#96588A] transition-colors cursor-default group">
                    <svg className="w-8 h-8 group-hover:scale-110 transition-transform" viewBox="0 0 24 24" fill="currentColor"><path d="M12 0C5.37 0 0 5.37 0 12c0 6.63 5.37 12 12 12 6.63 0 12-5.37 12-12 0-6.63-5.37-12-12-12zm4.39 16.32c-.52.26-2.58 1.15-3.04 1.35-.46.2-.82.16-1.12-.22-.3-.38-.6-1.16-.76-1.57-.16-.41-.44-.46-.86-.26-.42.2-1.78.85-2.22 1.05-.44.2-.87.42-1.25.64-.38.22-.64.44-1.25.64-.61.2-1.28-.2-1.28-.2s-1.38-.9-1.9-1.26c-.52-.36-.36-.92-.36-.92s.32-.56 1.9-1.26c1.58-.7 5.14-2.12 5.14-2.12s.9-.4 1.4-.4c.5 0 .9.4 1.4.4s3.56 1.42 5.14 2.12c1.58.7 1.9 1.26 1.9 1.26s.16.56-.36.92c-.52.36-1.9 1.26-1.9 1.26z"/></svg>
                    WooCommerce
                </div>
                <div className="flex items-center gap-3 text-xl font-bold text-slate-700 hover:text-[#F37623] transition-colors cursor-default group">
                    <svg className="w-8 h-8 group-hover:scale-110 transition-transform" viewBox="0 0 24 24" fill="currentColor"><path d="M12.9 2.1c-.5-.1-1.3-.1-1.8 0l-5.8 1.2-3.7 3.7c-.4.4-.6 1-.6 1.5v7c0 .6.2 1.1.6 1.5l3.7 3.7 5.8 1.2c.5.1 1.3.1 1.8 0l5.8-1.2 3.7-3.7c.4-.4.6-1 .6-1.5v-7c0-.6-.2-1.1-.6-1.5l-3.7-3.7-5.8-1.2zM7 12l5-5 5 5-5 5-5-5z"/></svg>
                    Magento
                </div>
                <div className="flex items-center gap-3 text-xl font-bold text-slate-700 hover:text-[#0084FF] transition-colors cursor-default group">
                    <svg className="w-8 h-8 group-hover:scale-110 transition-transform" viewBox="0 0 24 24" fill="currentColor"><path d="M12 0C5.373 0 0 5.265 0 11.765c0 3.706 2.059 7.029 5.294 9.088v3.853l3.294-1.794c1.088.294 2.235.471 3.412.471 6.627 0 12-5.265 12-11.765C24 5.265 18.627 0 12 0zm1.147 14.735l-3-3.206-5.853 3.206 6.441-6.824 3.029 3.206 5.824-3.206-6.441 6.824z"/></svg>
                    Messenger
                </div>
                <div className="flex items-center gap-3 text-xl font-bold text-slate-700 hover:text-[#25D366] transition-colors cursor-default group">
                    <svg className="w-8 h-8 group-hover:scale-110 transition-transform" viewBox="0 0 24 24" fill="currentColor"><path d="M12.031 0C5.396 0 0 5.373 0 12c0 2.123.554 4.116 1.517 5.862L.47 23.587l5.962-1.564A11.91 11.91 0 0012.031 24c6.634 0 12.031-5.373 12.031-12S18.665 0 12.031 0zm0 21.84a9.824 9.824 0 01-5.006-1.373l-.36-.213-3.716.974.993-3.623-.234-.373A9.824 9.824 0 013.99 12c0-5.41 4.402-9.84 9.84-9.84s9.84 4.43 9.84 9.84c0 5.424-4.416 9.84-9.839 9.84z"/></svg>
                    WhatsApp
                </div>
            </div>
        </div>
      ...
      <section id="product" className="py-24 px-6 max-w-7xl mx-auto w-full">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 md:grid-rows-2 gap-8">
          {/* Card 1 - Translation */}
          <div className="group bg-white border border-slate-200 rounded-[2rem] p-10 hover:-translate-y-2 hover:shadow-2xl hover:shadow-slate-200/50 transition-all duration-300 md:col-span-2 flex flex-col md:flex-row gap-8 items-center overflow-hidden relative">
            ...
            <div className="flex-1 relative z-10">
              <div className="w-14 h-14 rounded-2xl bg-slate-900 text-white flex items-center justify-center mb-6 shadow-xl shadow-slate-900/10">
              ...
              <h3 className="text-2xl font-bold text-slate-900 mb-4 group-hover:text-indigo-600 transition-colors">Tłumaczenie Native-like</h3>
              <p className="text-slate-500 text-base leading-relaxed">Silnik oparty na OpenAI i DeepL. Zachowuje kontekst, rozumie terminologię branżową i automatycznie wygładza ton. Latencja poniżej 50ms.</p>
            </div>
            <div className="hidden md:flex flex-1 flex-col gap-4 w-full opacity-80 group-hover:opacity-100 transition-opacity">
               <div className="bg-white border border-slate-100 p-5 rounded-2xl text-sm text-slate-600 shadow-sm flex items-center gap-3">
                 ...
                 <strong className="text-indigo-600 bg-indigo-50 px-3 py-1 rounded-lg">Das Produkt ist toll!</strong>
               </div>
               <div className="bg-white border border-slate-100 p-5 rounded-2xl text-sm text-slate-600 shadow-sm flex items-center gap-3">
                 <div className="w-2 h-2 rounded-full bg-slate-300"></div>
                 <span>"Zwrot środków"</span>
                 <svg className="w-4 h-4 text-slate-300 mx-auto" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M17 8l4 4m0 0l-4 4m4-4H3"></path></svg>
                 <strong className="text-indigo-600 bg-indigo-50 px-3 py-1 rounded-lg">Rückerstattung</strong>
               </div>
            </div>
          </div>

          {/* Card 2 - Omnichannel */}
          <div className="bg-white border border-slate-200 rounded-[2rem] p-10 hover:-translate-y-2 hover:shadow-2xl hover:shadow-slate-200/50 transition-all duration-300 md:row-span-2 flex flex-col relative overflow-hidden group">
            <div className="absolute bottom-0 left-0 w-full h-1/2 bg-gradient-to-t from-slate-50/50 to-transparent"></div>
            
            <div className="w-14 h-14 rounded-2xl bg-indigo-600 text-white flex items-center justify-center mb-6 shadow-xl shadow-indigo-600/20 relative z-10">
              <svg width="28" height="28" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M20 13V6a2 2 0 00-2-2H6a2 2 0 00-2 2v7m16 0v5a2 2 0 01-2 2H6a2 2 0 01-2-2v-5m16 0h-2.586a1 1 0 00-.707.293l-2.414 2.414a1 1 0 01-.707.293h-3.172a1 1 0 01-.707-.293l-2.414-2.414A1 1 0 006.586 13H4"></path></svg>
            </div>
            <h3 className="text-2xl font-bold text-slate-900 mb-4 relative z-10 group-hover:text-indigo-600 transition-colors">Omnichannel Inbox</h3>
            <p className="text-slate-500 text-base mb-10 relative z-10">Email, Chat, Messenger, WhatsApp - zarządzaj wszystkimi kanałami z jednego miejsca.</p>
            
            <div className="mt-auto flex flex-col gap-4 relative z-10">
               {['Messenger', 'WhatsApp', 'Email', 'Instagram DM'].map((app, i) => (
                   <div key={app} className="flex items-center justify-between p-4 bg-white border border-slate-100 rounded-xl shadow-sm hover:scale-[1.02] transition-transform cursor-default">
          ...
          {/* Card 3 - Marketing */}
          <div className="bg-white border border-slate-200 rounded-[2rem] p-10 hover:-translate-y-2 hover:shadow-2xl hover:shadow-slate-200/50 transition-all duration-300 group">
            <div className="w-14 h-14 rounded-2xl bg-pink-500 text-white flex items-center justify-center mb-6 shadow-xl shadow-pink-500/20">
              <svg width="28" height="28" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M11 5.882V19.24a1.76 1.76 0 01-3.417.592l-2.147-6.15M18 13a3 3 0 100-6M5.436 13.683A4.001 4.001 0 017 6h1.832c4.1 0 7.625-1.234 9.168-3v14c-1.543-1.766-5.067-3-9.168-3H7a3.988 3.988 0 01-1.564-.317z"></path></svg>
            </div>
            <h3 className="text-2xl font-bold text-slate-900 mb-4 group-hover:text-pink-600 transition-colors">Marketing Automation</h3>
            <p className="text-slate-500 text-base">Wbudowane narzędzia do newsletterów i pop-upów. Zwiększaj sprzedaż, gdy support śpi.</p>
          </div>

          {/* Card 4 (Dark) - Pay-per-Satisfaction */}
          <div className="bg-slate-900 text-white border border-slate-800 rounded-[2rem] p-10 hover:-translate-y-2 hover:shadow-2xl hover:shadow-slate-900/30 transition-all duration-300 relative overflow-hidden flex flex-col justify-between group">
            ...
            <div className="relative z-10">
                <div className="w-14 h-14 rounded-2xl bg-white/10 text-white flex items-center justify-center mb-6 backdrop-blur-sm border border-white/10">
        ...
        <div className="mt-20 border-t border-slate-100 pt-12 text-center">
            <h4 className="text-xs font-bold text-slate-400 uppercase tracking-widest mb-8">Bezpieczeństwo klasy Enterprise</h4>
            <div className="flex flex-wrap justify-center gap-8 md:gap-20 items-center">
                 <div className="flex items-center gap-3 text-slate-500 font-semibold hover:text-slate-800 transition-colors cursor-default">
                 ...
                 <div className="flex items-center gap-3 text-slate-500 font-semibold hover:text-slate-800 transition-colors cursor-default">
                    <svg width="24" height="24" fill="currentColor" viewBox="0 0 24 24"><path d="M18 8h-1V6c0-2.76-2.24-5-5-5S7 3.24 7 6v2H6c-1.1 0-2 .9-2 2v10c0 1.1.9 2 2 2h12c1.1 0 2-.9 2-2V10c0-1.1-.9-2-2-2zm-9-2c0-1.66 1.34-3 3-3s3 1.34 3 3v2H9V6zm9 14H6V10h12v10zm-6-3c1.1 0 2-.9 2-2s-.9-2-2-2-2 .9-2 2 .9 2 2 2z"/></svg>
                    AES-256 Encryption
                 </div>
                 <div className="flex items-center gap-3 text-slate-500 font-semibold hover:text-slate-800 transition-colors cursor-default">
      ...
      <footer id="contact" className="py-20 bg-white border-t border-slate-200">
        <div className="container mx-auto px-6 max-w-7xl">
            ...
            <div className="space-y-8">
                ...
                <p className="text-slate-500 font-light leading-relaxed max-w-md text-lg">
