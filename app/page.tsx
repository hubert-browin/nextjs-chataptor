      ...
      <section className="relative pt-40 md:pt-48 pb-16 md:pb-24 text-center overflow-hidden">
        ...
        <div className="px-4 md:px-6 max-w-7xl mx-auto relative z-10">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 md:gap-6 mb-16 md:mb-20 px-4">
            ...
            {/* UPDATED DEMO BUTTON */}
            <button className="group relative w-full sm:w-auto px-8 py-3.5 md:py-4 rounded-2xl bg-white text-slate-700 text-base font-bold shadow-lg shadow-indigo-100/50 border border-slate-100 hover:border-indigo-200 transition-all duration-300 flex items-center justify-center gap-3 active:scale-95 hover:text-indigo-600">
                <div className="relative flex items-center justify-center w-8 h-8 rounded-full bg-indigo-50 border border-indigo-100 group-hover:bg-indigo-100 group-hover:scale-110 transition-all duration-300">
                    <span className="absolute w-full h-full rounded-full bg-indigo-400/20 animate-ping opacity-0 group-hover:opacity-100"></span>
